...
public class TestDataDTOBuilder {
	...
	public ProductDTO getNullNameRomProductDTO() {
		return ProductDTO.builder()
				...
				.subcategory(SubcategoryDTONoCategory.builder().build())
				.measuringUnit(MeasuringUnitDTO.builder().build())
				.vat(VatDTO.builder().build())
				.barcodes(new ArrayList<BarcodeDTO>())
				.plu(PluDTO.builder().build())
				.productCode(ProductCodeDTO.builder().build())
				.build();
	}
	...
	public ProductDTO getNegativeTradeMarginProductDTO() {
		return ProductDTO.builder()
				...
				.category(CategoryDTO.builder().build())
				.subcategory(SubcategoryDTONoCategory.builder().build())
				.tradeMargin(BigDecimal.valueOf(-0))
				.measuringUnit(MeasuringUnitDTO.builder().build())
				.vat(VatDTO.builder().build())
				.barcodes(new ArrayList<BarcodeDTO>())
				.plu(PluDTO.builder().build())
